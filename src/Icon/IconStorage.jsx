...
export const Ticket = ({ width = "1.9em", height = "1.9em" }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export const Surf = ({ width = "1.9em", height = "1.9em" }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export const LandScape = ({ width = "1.9em", height = "1.9em" }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
        ...
        >
            <g
                ...
                strokeLinejoin="round"
            >
                <path d="M.576 6.733a6.5 6.5 0 0 1 1.164-.104c1.58 0 3.027.563 4.154 1.5" />
...
export const Cabin = ({ width = "1.9em", height = "1.9em" }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
        ...
        >
            <path
                fill="currentColor"
                d="M6 19h12v-2H6zm0-4h12v-2H6zm0-4h12v-.9L16.55 9h-9.1L6 10.1zm4.05-4h3.9L12 5.525zM4 21v-9.375L2.2 13L1 11.4l3-2.3V6h2v1.575L12 3l11 8.4l-1.2 1.575l-1.8-1.35V21zM4 5q0-1.25.875-2.125T7 2q.425 0 .713-.288T8 1h2q0 1.25-.875 2.125T7 4q-.425 0-.712.288T6 5z"
            ></path>
        </svg>
    );
};

export const Breakfast = ({ width = "1.9em", height = "1.9em" }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
        ...
        >
            <g
                ...
                color="currentColor"
            >
                <path d="M18.25 10.5h1.39c1.852 0 2.402.265 2.357 1.584c-.073 2.183-1.058 4.72-4.997 5.416"></path>
                <path d="M5.946 20.615C2.572 18.02 2.075 14.34 2.001 10.5c-.031-1.659.45-2 2.658-2h10.682c2.208 0 2.69.341 2.658 2c-.074 3.84-.57 7.52-3.945 10.115c-.96.738-1.77.885-3.135.885H9.081c-1.364 0-2.174-.147-3.135-.886"></path>
                <path d="M10 8.5v5m-1.496 2.797l.292-1.852c.086-.542.598-.945 1.203-.945c.604 0 1.117.403 1.202.945l.292 1.852c.158.997-3.127.876-2.989 0M11.309 2.5C10.762 2.839 10 4 10 5.5M7.54 4S7 4.5 7 5.5M14.001 4c-.273.17-.501 1-.501 1.5"></path>
            </g>
        </svg>
    );
};

export const BeachFront = ({ width = "2em", height = "2em" }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export const Skiing = ({ width = "2em", height = "2em" }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export const Snowing = ({ width = "1.9em", height = "1.9em" }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export const Mansion = ({ width = "1.9em", height = "1.9em" }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export const Camping = ({ width = "1.9em", height = "1.9em" }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export const Pool = ({ width = "1.9em", height = "1.9em" }) => {
    return (
        ...
        >
            ...
            ></path>
            <circle cx={16.5} cy={5.5} r={2.5} fill="currentColor"></circle>
        </svg>
    );
};

export const Reputation = ({ width = "1.9em", height = "1.9em" }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
