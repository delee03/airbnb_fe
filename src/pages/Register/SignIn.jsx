...
import { SvgFacebook, SvgGoogle, SvgApple, SvgEmail } from "./SvgFacebook";
    ...
    <section className="">
      <div className="fixed inset-0 flex items-center justify-center bg-gray-600 bg-opacity-50">
        ...
        <div className="bg-white w-full max-w-md mx-auto p-6 rounded-lg shadow-lg">
          ...
          {/* Header */}
          <h2 className="text-center text-xl font-semibold mb-6">Đăng nhập</h2>
          ...
          /> */}
            ...
            <p className="text-sm text-black mt-2 mb-2">
              Bấm vào để
              <a href="#" className="text-black font-semibold ml-1 underline">
                Đăng ký
              </a>
            </p>
            {/* SignIn Button */}
