...
const AdminTemplate = () => {
  ...
  if (isAdminPage) {
    ...
    useEffect(() => {
      if (!havePermission) {
        message.warning("Bạn không có quyền truy cập vào trang này nhé", 3);
        setTimeout(() => {
              ...
              <Menu
                ...
                items={[
                  ...
                  },
                  {
                    ...
                    label: <Link to={"user-manage"}>Quản lý người dùng</Link>,
                  },
                  {
                    key: "2",
                  ...
                  },
                  {
                    key: "3",
                    icon: <i className="fa-solid fa-briefcase"></i>,
                    label: <Link to={"room-manage"}>Quản lý phòng</Link>,
                  },
                  {
                    key: "4",
                    icon: <i className="fa-regular fa-handshake"></i>,
                    label: <Link to={"booking-manage"}>Quản lí đặt phòng</Link>,
                  },
                ]}
              />
            </div>
